...
namespace GameTank
{
    class Program
    {
        ...
        static char [,] buatRuang(int panjangRuang, char tank, char rumput, int totalTank){
            ...
            return letakTank(ruangan,totalTank,rumput,tank);
        }

        //meletakkan tank di dalam area
        static char[,] letakTank(char[,]ruangan, int jumlahTank, char rumput, char tank){
            int letakTank = 0;
            int panjangRuang = 5;
